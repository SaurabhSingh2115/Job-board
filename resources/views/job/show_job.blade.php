...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
     ...
     <style>
        body {
          background-color: #1e1e2f; /* Dark background for the page */
          color: #fff; /* Default text color for labels and other elements */
        }

        .form-control {
          background-color: #2a2a3d; /* Dark gray background for input fields */
          color: #fff; /* White text for better contrast */
          border: 1px solid #444; /* Subtle border for input fields */
        }

        .form-control:disabled {
          background-color: #2a2a3d; /* Keep consistent color for disabled inputs */
          opacity: 1; /* Avoid default dimming of disabled fields */
        }
        ...
        h4.card-title {
          color: #fff; /* White color for card title */
        }
