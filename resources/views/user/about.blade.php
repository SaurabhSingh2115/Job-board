      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-5 mb-lg-0 order-md-2">
            <a data-fancybox data-ratio="2" href="https://www.youtube.com/watch?v=xoQMwFRNvdQ" class="block__96788">
              <span class="play-icon"><span class="icon-play"></span></span>
      ...
      <div class="container">
        ...
        <div class="row align-items-center block__69944">
          ...
          <div class="col-md-6">
            ...
            <p>Meet Ayush, our talented Creative Director. With a passion for innovative design and a keen eye for detail,. He is driven by the desire to create exceptional user experiences and deliver outstanding visual solutions to our clients.</p>
          ...
          <div class="col-md-6">
            <h3>Vinay</h3>
            <p class="text-muted">Creative Director</p>
            <p>Meet Vinay, our talented Creative Director. With a passion for innovative design and a keen eye for detail,. He is driven by the desire to create exceptional user experiences and deliver outstanding visual solutions to our clients. </p>
            <div class="social mt-4">
              <a href="#"><span class="icon-facebook"></span></a>
              <a href="#"><span class="icon-twitter"></span></a>
              <a href="#"><span class="icon-instagram"></span></a>
